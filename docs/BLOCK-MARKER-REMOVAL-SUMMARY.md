...
#### 2. `language/01-syntax-complete.md` (4 occurrences updated)
**Changes:**
...
#### 3. `language/12-bnf-grammar.md` (6 occurrences updated)
**Changes:**
...
#### 4. `language/06-block-markers.md` (5 occurrences updated)
**Changes:**
...
#### 5. `language/07-macros.md` (8 occurrences - automated replacement)
**Changes:** All `[=]` → `[i]` via sed

#### 6. `architecture/05-runtime-execution.md` (1 occurrence - automated replacement)
**Changes:** `[=]` → `[i]` via sed
