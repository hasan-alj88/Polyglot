...
**Then** all operators are represented:
- `[|]` (Pipeline), `[X]` (Exit), `[r]` (Return), `[p]` (Parallel)
- `[Q]` (Queue), `[w]` (Wrapper), `[t]` (Timing), `[#]` (Directives)
- Identifiers, literals (strings, numbers, booleans)
