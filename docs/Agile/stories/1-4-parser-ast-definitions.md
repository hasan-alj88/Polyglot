...
**From Architecture Document** [Source: docs/Tech/implementation/technical/architecture.md]
...
**From Story 1.2 (Status: done)** [Source: docs/Agile/stories/1-2-lexer-token-definitions.md]
...
7. **Error Handling Design**:
   ...
   - **Design Reference**: See `docs/Tech/implementation/technical/parser-error-detection-design.md` for complete specification
   - **Story 1.4 Scope**: Define error *types* only; Story 1.5 implements error *detection logic*

### References

- [Source: docs/Agile/epics.md#Story-1.4]
- [Source: docs/Tech/implementation/technical/architecture.md#Technology-Stack-Details]
- [Source: docs/Tech/implementation/technical/architecture.md#ADR-004-Error-Handling]
- [Source: docs/Tech/implementation/technical/architecture.md#ADR-014-String-Concatenation-Operator]
- [Source: docs/Tech/implementation/technical/parser-error-detection-design.md] - **Comprehensive error detection system**
- [Source: docs/Tech/implementation/technical/block-hierarchy-reference.md] - Block nesting validation rules
...
- [Source: docs/Agile/stories/1-2-lexer-token-definitions.md] - Similar pattern
