...
### Primary References
1. `/docs/Agile/examples/LEXER-TOKEN-SPECIFICATION.md` - Token types and state machine
2. `/docs/Agile/examples/LEXER-PATTERN-TREES.md` - Pattern recognition
3. `/docs/Agile/examples/STRING-LITERAL-TOKENIZATION-STRATEGY.md` - String handling

### Supporting References
4. `/docs/Tech/implementation/technical/string-literals-internals.md` - String processing mechanics
5. `/docs/Tech/implementation/technical/architecture.md` - System architecture
