...
- **ADR-004**: Error Handling with thiserror (docs/Tech/implementation/technical/architecture.md)
- **ADR-014**: String Concatenation Operator (docs/Tech/implementation/technical/architecture.md)
- **Block Hierarchy**: docs/Tech/implementation/technical/block-hierarchy-reference.md
- **Line Continuation**: docs/user/language/line-continuation.md
- **Story 1.4**: docs/Agile/stories/1-4-parser-ast-definitions.md
- **Story 1.5**: docs/Agile/stories/1-5-parser-implementation.md (future)
