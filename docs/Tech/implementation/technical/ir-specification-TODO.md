...
**Proposed outline for `docs/Tech/implementation/technical/ir-specification.md`:**
...
1. `docs/Tech/implementation/technical/variable-states-specification.md` - Variable state model
...
4. `docs/Tech/implementation/technical/architecture.md` - How 3 IRs are used by services
