...
### [📐 Design Specifications](DESIGN-SPECIFICATIONS-CATALOG.md)

**Audience:** Language designers, architects, contributors
**Purpose:** Version specifications, design decisions, brainstorming sessions
...
**Key Versions:**
- **v0.0.4 Loop System** - Mini-pipeline iterations (✅ Complete) - [specifications/v0.0.4/loop-system/](specifications/v0.0.4/loop-system/)
- **v0.0.4 Syntax Refinement** - 30 features (🔧 Design Phase) - [specifications/v0.0.4/syntax-refinement/](specifications/v0.0.4/syntax-refinement/)
- **v0.0.5 Type System** - Future proposals (💡 Concept) - [specifications/v0.0.5/](specifications/v0.0.5/)
- **Brainstorming Sessions** - Design evolution - [specifications/brainstorming/](specifications/brainstorming/)

**Organization:** [Complete Catalog](DESIGN-SPECIFICATIONS-CATALOG.md) with 23 specifications organized by version and category

**Navigation:** Each folder includes comprehensive README.md with detailed guides

**Source of Truth for:** Language design decisions, version specifications, and design evolution

**Recent Change:** Reorganized into version-based folder structure (2025-12-12)

---

### [🤖 AI Context Packages](ai-context/)

**Audience:** AI agents, LLMs, code analysis tools
**Purpose:** Machine-parseable language specifications optimized for AI consumption
...
```
ai-context/
├── v0.0.2/                      # v0.0.2 AI context (OUTDATED - historical)
...
│   ├── constraints.yaml         # Edge cases and validation
│   ├── datetime-system.yaml     # DateTime type specification
│   └── ... (13 files total)
└── README.md                    # Version index and usage guide
```

**Available Versions:**
- **v0.0.2** - ⚠️ Historical reference (language has evolved)
- **v0.0.3** - 🚧 To be created (current stable)
- **v0.0.4** - 💡 Planned after implementation
...
**Current Status:** v0.0.2 available (outdated), refer to [user documentation](user/) for current syntax

**Source of Truth for:** Machine-readable language specifications by version

**Recent Change:** Reorganized into version-based structure (2025-12-12)
...
**Understanding language design decisions?**
→ See [Design Specifications Catalog](DESIGN-SPECIFICATIONS-CATALOG.md) for version specs and brainstorming sessions
...
**Documentation Structure Updated:** 2025-12-12
**Major Reorganization:** 2025-12-12 (Version-based folder structure)
**Maintained By:** Polyglot Documentation Team
**Design Specifications:** 23 documents organized in specifications/ folder
**AI Context Packages:** Version-based structure (v0.0.2 available)
