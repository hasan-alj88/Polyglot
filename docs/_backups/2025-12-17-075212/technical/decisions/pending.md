...
**Related Artifacts**:
- Incorrect specification: `docs/technical/architecture.md` ADR-013 (lines 1400-1487)
- Incorrect meeting minutes: `docs/project/meetings/2025-11-18-tokens-and-string-literals.md`
- Blocked story: `docs/project/stories/1-2-lexer-token-definitions.md`
...
- ITIL configuration exists in `docs/project/itil-config.yaml` with comprehensive ticket types, priorities, and assignment groups
...
2. Where should ITIL tickets be stored? (YAML files in docs/project/tickets/, GitHub Issues, or other?)
...
**Related Artifacts**:
- Existing configuration: `docs/project/itil-config.yaml`
- TODO item: TODO-014 in `docs/project/project-todo.yaml`
