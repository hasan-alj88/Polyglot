...
[i] .max_retries: pg\int <~ 3  // Comment is outdated!
```
...
- [Complete Syntax Reference](syntax-complete.md) - Comments overview
- [Type System](type-system.md) - Type separator `\` vs comment `/`
