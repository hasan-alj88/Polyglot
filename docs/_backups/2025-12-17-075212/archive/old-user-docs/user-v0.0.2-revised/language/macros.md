...
- [Block Markers](block-markers.md) - Macro-specific blocks: `[M]`, `[W]`, `[{]`, `[}]`, `[i]`
- [Operators](operators.md) - Assignment operators used in macros
- [Type System](type-system.md) - Type safety in macro scope flow
