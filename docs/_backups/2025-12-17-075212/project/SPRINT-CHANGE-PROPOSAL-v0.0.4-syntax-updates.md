...
**Location:** `docs/project/prd.md` - After frontmatter (line ~7)
...
**Location:** `docs/project/prd.md` - Lines 449-458
...
**Location:** `docs/project/prd.md` - Lines 550-560
...
**Location:** `docs/project/prd.md` - Line 772
...
**Location:** `docs/project/prd.md` - Lines 1084, 1273
...
2. Archive in docs/project/ for reference
