...
Polyglot is a precision automation language designed for orchestrating complex workflows across multiple runtime environments. This documentation covers the complete v0.0.2 language specification, standard library, examples, and tooling.
...
- [IR Representation](architecture/01-ir-representation.md) - Intermediate Representation
- [Queue System](architecture/02-queue-system.md) - Queue architecture
- [Trigger Monitoring](architecture/03-trigger-monitoring.md) - Trigger system
- [Runtime Execution](architecture/04-runtime-execution.md) - Execution model
...
3. Review [IR Representation](architecture/01-ir-representation.md)
4. Understand [Queue System Architecture](architecture/02-queue-system.md)
...
- [Decision Log](decision-log.md) - All v0.0.2 syntax decisions
- [Inconsistencies Log](inconsistencies-log.md) - v0.0.1 issues resolved
- [Reserved Enumeration Schemas](reserved-enumeration-schema-decisions.md) - Enum schema decisions *(pending)*
- [Documentation Plan](documentation-plan.md) - Documentation progress tracking

### Decision Reference
All documentation is based on 30 syntax decisions documented in [decision-log.md](decision-log.md). Key decisions:
...
- See [complete decision log](decision-log.md) for all 30 decisions
...
### Changes from v0.0.1
v0.0.2 resolves 30 inconsistencies found in v0.0.1 documentation:
...
- Follow [kebab-case](decision-log.md#issue-17-file-naming-inconsistencies) for file names
...
### Support
- Documentation Issues: See [decision-log.md](decision-log.md)
...
**Note:** This documentation is for v0.0.2 of the Polyglot language. The language is in active development, and this documentation represents the current specification based on resolved design decisions.

For historical reference, v0.0.1 documentation is archived but should not be used due to inconsistencies. All new projects should use v0.0.2 documentation.