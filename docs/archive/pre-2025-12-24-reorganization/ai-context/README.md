...
- See [version roadmap](../User/specifications/version-roadmap.md) for details
...
**Design Specs:** See [/docs/User/specifications/v0.0.4/](../User/specifications/v0.0.4/)
...
| **Design Specs** ([/specifications](../User/specifications/)) | Evolution | Design documents | Language designers |
| **Technical Docs** ([/technical](../Tech/implementation/technical/)) | Architecture | Architecture docs | Implementers |
...
**For upcoming syntax:** See [/docs/User/specifications/v0.0.4/](../User/specifications/v0.0.4/) design specs
...
**Design Specifications:** [/docs/User/specifications/](../User/specifications/)
**Technical Architecture:** [/docs/Tech/implementation/technical/](../Tech/implementation/technical/)
**Project Planning:** [/docs/Agile/](../Agile/)
