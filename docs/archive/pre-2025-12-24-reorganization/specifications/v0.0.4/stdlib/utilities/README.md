...
**See:**
- [Inline Pipelines Complete Specification](../../User/language/advanced/inline-pipelines.md) - Full three-phase execution model
- [Pipeline Structure - %Inline Metadata](../../User/language/control-flow/pipeline-structure.md#7-inline-metadata---making-pipelines-inline-callable) - How to register formatter pipelines
- [Prefix System - %Inline.FormattedString Special Variable](../../User/language/syntax/prefix-system.md#the-inlineformattedstring-special-variable) - Metadata prefix and special variables
- [Core Principles - Inline Pipeline Calls](../../User/getting-started/core-principles.md#4-inline-pipeline-calls) - Introduction to inline syntax
...
- [Loop System](../../User/language/advanced/loop-system.md) - Using utilities in loops
- [Inline Pipelines](../../features/string-handling/inline-pipelines.md) - Inline syntax
- [Serial Load Block](../../User/language/advanced/serial-load-block.md) - Loading data files
