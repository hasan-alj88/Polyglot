...
- **PRD:** `docs/Agile/prd.md` - Product Requirements Document
- **Epics:** `docs/Agile/epics.md` - Epic breakdown
- **Architecture (Sharded):** `docs/Tech/implementation/technical/architecture/` (12 files)

### User Stories (Epic 1 - Parser Implementation)
Located in `docs/Agile/stories/`:
...
Located in `docs/Tech/implementation/technical/architecture/`:
...
Located in `docs/Tech/implementation/technical/`:
...
### Lexer Examples
Located in `docs/Agile/examples/`:
...
Located in `docs/Tech/ai-context/`:
