...
original_path: user/documentation-plan.md
---
...
│   ├── 00-quick-start.md             # Quick start guide (beginners)
│   ├── 01-syntax-complete.md         # Complete syntax reference
│   ├── 02-type-system.md             # Type system specification
│   ├── 03-enumerations.md            # Enumeration system
│   ├── 04-error-handling.md          # Error handling (!Error types)
│   ├── 05-operators.md               # All operators (|, ~, @, #, !, <<, >>)
│   ├── 06-block-markers.md           # All block markers ([|], [i], [r], etc.)
│   ├── 07-datetime-system.md         # DT literals and calendars
│   ├── 08-parallel-execution.md      # Parallel blocks and join
│   ├── 09-expansion-operator.md      # [~] nesting rules
│   ├── 10-pipeline-lifecycle.md      # Instances, execution, queues
│   └── 11-comments.md                # Comment syntax
│
├── standard-library/                  # Standard library reference
│   ├── 00-overview.md                # Standard library organization
│   ├── 01-runtime-wrappers.md        # |W.* wrappers (Python, Node, etc.)
│   ├── 02-queue-control.md           # |Q.* queue operations
│   ├── 03-utilities.md               # |U.* utilities (TBD - catalog first)
│   ├── 04-triggers.md                # |T.* trigger patterns (TBD)
│   ├── 05-join-operations.md         # |Y.* join operations
│   └── 06-reserved-enumerations.md   # #Path, #Queues, #DT, #Status, #None
│
...
│   ├── 00-workflow.md                # Compile → Register → Activate
│   ├── 01-compile.md                 # polyglot compile
│   ├── 02-register.md                # polyglot register
│   ├── 03-activate.md                # polyglot activate
│   └── 04-test.md                    # polyglot test (TBD)
│
├── packages/                          # Package management
│   ├── 00-overview.md                # Package system overview
│   ├── 01-registries.md              # Local, Community, Company registries
│   ├── 02-creating-packages.md       # How to create packages
│   └── 03-importing-packages.md      # How to import/use packages
│
...
**File:** `language/01-syntax-complete.md`
**Status:** ☐ NOT STARTED
**Dependencies:** None
...
**File:** `language/02-type-system.md`
**Status:** ☐ NOT STARTED
...
**File:** `language/03-enumerations.md`
**Status:** ☐ NOT STARTED
...
**File:** `language/04-error-handling.md`
**Status:** ☐ NOT STARTED
...
**File:** `language/06-block-markers.md`
**Status:** ☐ NOT STARTED
**Dependencies:** Section 1.2 (syntax reference)
...
**File:** `language/07-datetime-system.md`
**Status:** ☐ NOT STARTED
**Dependencies:** Section 1.3 (type system)
**Decisions Used:** #3
...
**File:** `language/08-parallel-execution.md`
**Status:** ☐ NOT STARTED
...
**File:** `language/09-expansion-operator.md`
**Status:** ☐ NOT STARTED
...
**File:** `language/10-pipeline-lifecycle.md`
**Status:** ☐ NOT STARTED
...
**File:** `standard-library/00-overview.md`
**Status:** ☐ NOT STARTED
...
**File:** `standard-library/01-runtime-wrappers.md`
**Status:** ☐ NOT STARTED
...
**File:** `standard-library/02-queue-control.md`
**Status:** ☐ NOT STARTED
...
**File:** `standard-library/03-utilities.md`
**Status:** ☐ NOT STARTED
**Dependencies:** Section 3.1 (stdlib overview)
**Decisions Used:** #25
...
**File:** `standard-library/04-triggers.md`
**Status:** ☐ NOT STARTED
...
**File:** `standard-library/06-reserved-enumerations.md`
...
**Files:** `cli/01-compile.md`, `cli/02-register.md`, `cli/03-activate.md`, `cli/04-test.md`
**Status:** ☐ NOT STARTED
...
**File:** `packages/01-registries.md`
**Status:** ☐ NOT STARTED
...
**Files:** `architecture/00-overview.md`, `01-ir-representation.md`, `02-queue-system.md`, `03-trigger-monitoring.md`, `04-runtime-execution.md`
**Status:** ☐ NOT STARTED
