...
original_path: user/architecture/05-runtime-execution.md
---
...
**Last Updated:** 2025-11-19
**Related Documents:**
- [Block Markers](../language/06-block-markers.md) - Complete block marker reference
- [Error Handling](../language/04-error-handling.md) - Error handling patterns
- [Parallel Execution](../language/08-parallel-execution.md) - Advanced parallel patterns
