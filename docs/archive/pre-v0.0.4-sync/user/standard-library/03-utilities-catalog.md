...
original_path: user/standard-library/03-utilities-catalog.md
---
...
- [Type System](../language/02-type-system.md) - Type inference and compatibility
- [Error Handling](../language/04-error-handling.md) - Handling format errors
