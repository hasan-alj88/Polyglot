...
original_path: user/audit/documentation-audit-report.md
---
...
### File: `/docs/user/language/06-block-markers.md`
...
✅ `/docs/user/language/01-syntax-complete.md`
✅ `/docs/user/language/02-type-system.md`
✅ `/docs/user/language/03-enumerations.md`
✅ `/docs/user/language/05-operators.md`
✅ `/docs/user/language/07-datetime-system.md`
✅ `/docs/user/language/08-parallel-execution.md`
✅ `/docs/user/language/09-expansion-operator.md`
✅ `/docs/user/language/10-pipeline-lifecycle.md`
✅ `/docs/user/language/11-comments.md`
