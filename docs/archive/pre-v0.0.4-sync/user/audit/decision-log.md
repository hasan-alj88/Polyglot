...
original_path: user/audit/decision-log.md
---
...
- [ ] Document datatype as `:pg.dt` (not `:pg.time`)
...
- Follow **correct type syntax** (`:pg.type`) (Decision #2)
...
**Pattern:**
```markdown
[Link Text](/docs/user/planning/architecture/02-compiler.md)
```
