...
original_path: user/language/10-pipeline-lifecycle.md
---
...
- [Complete Syntax Reference](01-syntax-complete.md) - Pipeline syntax
- [Block Markers](06-block-markers.md) - `[|]`, `[Q]` markers
- [Parallel Execution](08-parallel-execution.md) - Multiple instances

### Standard Library
- [Queue Control](../standard-library/02-queue-control.md) - `|Q.*` operations
- [Triggers](../standard-library/04-triggers.md) - Instance creation via triggers
