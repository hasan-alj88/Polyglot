...
original_path: user/language/04-error-handling.md
---
...
- [Type System](02-type-system.md) - Error types
- [Enumerations](03-enumerations.md) - Relationship to enumerations
- [Complete Syntax Reference](01-syntax-complete.md) - `[!]` syntax
