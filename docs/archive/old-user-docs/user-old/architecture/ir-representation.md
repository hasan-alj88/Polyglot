...
### Architecture
- [System Architecture Overview](./overview.md) - High-level design
- [Database Schema](./database-schema.md) - IR storage tables

### Language Specification
- [BNF Grammar](../language/bnf/polyglot grammer.md) - Complete grammar
- [Type System](../language/type-system.md) - Type specifications
...
- [System Architecture](./overview.md) - Component design
- [Database Schema](./database-schema.md) - Complete schema
- [Type System](../language/type-system.md) - Language type specs
- [Enumerations](../language/enumerations.md) - Enumeration system
