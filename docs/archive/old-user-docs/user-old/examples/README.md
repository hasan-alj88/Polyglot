...
4. **Next:** [Quick Start Guide](../language/quick-start.md)
...
5. **Next:** [Standard Library](../standard-library/overview.md)
...
5. **Next:** [Trigger Catalog](../standard-library/triggers.md)
...
### Core Examples
- [01: Hello World](hello-world.md) - Approved beginner examples
...
- [07: Approved Examples](approved-examples.md) - Curated collection
...
- [Quick Start Guide](../language/quick-start.md) - Get started quickly
- [Complete Syntax](../language/syntax-complete.md) - Full syntax reference
- [Type System](../language/type-system.md) - Cross-language types
- [BNF Grammar](../language/bnf/polyglot grammer.md) - Authoritative grammar

### Reference Documentation
- [Standard Library](../standard-library/overview.md) - Built-in utilities
- [Trigger Catalog](../standard-library/triggers.md) - All trigger types
- [Queue Control](../standard-library/queue-control.md) - Queue operations

### Architecture
- [System Architecture](../architecture/overview.md) - How Polyglot works
- [IR Representation](../architecture/ir-representation.md) - Type system internals
