...
2. **Study Standard Library:**
   - [Utilities Catalog](../standard-library/utilities.md)
   - [Triggers Catalog](../standard-library/triggers.md)
   - [Queue Control](../standard-library/queue-control.md)
...
- [Quick Start Guide](../language/quick-start.md) - Getting started
