...
3. **Error Handling Reference** - [Error Handling Documentation](../language/error-handling.md)
...
- [Type System](../language/type-system.md) - Understanding !Error types
- [Serial Load Blocks](../language/block-markers.md#s---serial-load-block) - `[s]` block syntax
- [Serial Error Handling](../language/error-handling.md#serial-block-error-handling-s) - `[s][!]` complete reference
