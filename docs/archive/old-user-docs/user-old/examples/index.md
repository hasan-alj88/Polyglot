...
1. [Hello World Examples](hello-world.md) - Your first Polyglot programs
2. [Data Processing Examples](data-processing.md) - Basic data operations
3. [Error Handling Examples](error-handling.md) - Handling errors gracefully
...
1. [Parallel Execution Examples](parallel-execution.md) - Concurrent programming
2. [File Operations Examples](file-operations.md) - Working with files and paths
3. [Complete Workflows](complete-workflows.md) - Combining multiple features
...
1. [Complete Workflows](complete-workflows.md) - Multi-pipeline orchestration
...
**File:** [hello-world.md](hello-world.md)
...
**File:** [data-processing.md](data-processing.md)
...
**File:** [parallel-execution.md](parallel-execution.md)
...
**File:** [file-operations.md](file-operations.md)
...
**File:** [complete-workflows.md](complete-workflows.md)
...
See [CLI Documentation](../cli/workflow.md) for complete details.
...
- Refer to [Complete Syntax Reference](../language/syntax-complete.md)
...
1. **Start with Hello World:** [hello-world.md](hello-world.md)
2. **Review Language Basics:** [Complete Syntax Reference](../language/syntax-complete.md)
3. **Explore Your Use Case:** Use the "By Use Case" table above
4. **Practice and Experiment:** Modify examples to deepen understanding

## See Also

- [Complete Syntax Reference](../language/syntax-complete.md) - Full language syntax
- [Type System](../language/type-system.md) - Understanding types
- [Error Handling](../language/error-handling.md) - Error handling details
- [Parallel Execution](../language/parallel-execution.md) - Concurrency patterns
- [Standard Library Overview](../standard-library/overview.md) - Available utilities

---

**Navigation:**
[Language Documentation](../language/syntax-complete.md) | [Standard Library](../standard-library/overview.md) | [Hello World →](hello-world.md)