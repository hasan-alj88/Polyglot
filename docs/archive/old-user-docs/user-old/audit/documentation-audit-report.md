...
1. [hello-world.md](../examples/hello-world.md) - 12 violations
2. [error-handling.md](../language/error-handling.md) - 3 violations
3. [block-markers.md](../language/block-markers.md) - 3 violations

---

## Detailed Findings

### File: `/docs/user/examples/hello-world.md`
...
### File: `/docs/user/language/block-markers.md`
...
✅ `/docs/user/language/syntax-complete.md`
✅ `/docs/user/language/type-system.md`
✅ `/docs/user/language/enumerations.md`
✅ `/docs/user/language/operators.md`
✅ `/docs/user/language/datetime-system.md`
✅ `/docs/user/language/parallel-execution.md`
✅ `/docs/user/language/expansion-operator.md`
✅ `/docs/user/language/pipeline-lifecycle.md`
✅ `/docs/user/language/comments.md`
...
|-----------|-------|----------------|
| **#10 - Missing `[~]` Expansion for Error Blocks** | 6 | hello-world.md (3), error-handling.md (2), block-markers.md (1) |
| **#11 - Missing Blank Lines Before Blocks** | 4 | hello-world.md (3), error-handling.md (1) |
| **#1 - Output Declaration Without Computation** | 2 | hello-world.md (2) |

### High Violations (6 instances)

| Violation | Count | Files Affected |
|-----------|-------|----------------|
| **#2 - Error Throwing Pattern** | 2 | hello-world.md (2) |
| **#9 - Variable Immutability Patterns** | 2 | hello-world.md (2) |
...
1. **Fix hello-world.md** - This is the primary example file and contains the most violations (12). Must be fixed immediately as it teaches incorrect patterns.

2. **Fix error-handling.md** - Core language documentation showing wrong error handling patterns.

3. **Fix block-markers.md** - Reference documentation showing incorrect syntax.
