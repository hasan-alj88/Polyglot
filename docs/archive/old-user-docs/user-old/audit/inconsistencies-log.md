...
**Status:** ✅ RESOLVED in v0.0.2

> **📌 RESOLUTION NOTE (2025-11-20):**
> All critical inconsistencies documented in this report were **RESOLVED in v0.0.2 specification**.
> - **Type Separator:** Standardized on backslash `\` (see decision-log.md)
> - **Maps:** Removed, replaced with enumerations
> - **DateTime System:** Standardized on `DT"..."` prefix
> - **All other contradictions:** Resolved in v0.0.2 language specification
>
> This document is preserved as a **historical record** showing the v0.0.1 analysis that led to v0.0.2.
...
**Conflict:**
- **File:** `/reference/type-system.md` (Lines 168-189)
...
```polyglot
// reference/type-system.md says NO MAPS:
[#] UserAges
[D] .alice: pg/int << 30
[X]
...
- Option B: Keep maps, remove "maps removed" statement from type-system.md
...
- **Mutable Separator:** Uses `\` (backslash)
  - `/reference/syntax-complete.md` (Line 122): `pg.mutable\int`
  - `/reference/type-system.md` (Line 39): `language.modifier\type`
...
**Version B:** `/language/syntax-reference.md` and `/reference/syntax-complete.md`
- Uses `T"..."` prefix only
...
// language/syntax-reference.md & reference/syntax-complete.md:
...
| planning/prd/overview.md | 1.0 | Nov 2025 | Active Development - Design Phase |
| language/syntax-reference.md | 1.0.0 | (not specified) | (not specified) |
| reference/syntax-complete.md | 1.0.0 | 2025-11-08 | (not specified) |
| reference/type-system.md | 1.0.0 | 2025-11-08 | (not specified) |
...
**File:** `/reference/syntax-complete.md` (Lines 29-35)
...
**File:** `/reference/syntax-complete.md` (Line 263-274)
...
**File:** `/reference/syntax-complete.md` (Lines 246-252)
```
- Default
- Fixed
- True
...
**System B:** reference/type-system.md (Lines 181-187)
```polyglot
[#] UserAges
[D] .alice: pg/int << 30
[D] .bob: pg/int << 25
...
**Documented Meaning:**
- `Fixed` - Immutable constant defined at declaration (language/block-types.md Line 289)
- `Default` - Optional input with fallback value (language/block-types.md Line 303)
...
[i] .api_key: pg\string << "secret-key-123"     \ Constant
[i] .chunk_size: pg\int <~ 1024               \ Optional with default
```

**Example from language/syntax-reference.md (Lines 168-187):**
Previously used incorrect `Fixed` keyword for multi-line map literals:
```polyglot
...
**✅ RESOLVED:** The "Fixed" and "Default" keywords do NOT exist in Polyglot.

**Correct Syntax:**
- Constants (immediately Ready): `[i] .var: Type << value`
- Defaults (optional with default): `[i] .var: Type <~ value`
- Required (Declared state): `[i] .var: Type`

**No keywords needed** - the operators (`<<` vs `<~`) express the intent.
...
**Stated Rule:** `/reference/syntax-complete.md` (Line 128)
...
**File:** reference/type-system.md (Lines 326-330)
...
**Example: Type System**
- Appears in: `language/02-data-types.md`, `reference/type-system.md`, `language/syntax-reference.md`
- Each version has slight differences in examples, completeness
- Creates confusion about which is authoritative

**Example: Core Syntax**
- Appears in: `language/01-core-syntax.md`, `reference/syntax-complete.md`, `language/syntax-reference.md`
...
**Language docs** (language/block-types.md, syntax-reference.md) show:
- Python execution via wrappers: `[W] |W.Python3.10`
- Runtime specified in pipeline

**Architecture docs** (planning/architecture/overview.md Lines 198-209) show:
...
**Architecture** (planning/architecture/overview.md Lines 159-173) describes:
- Three queues: Pending, Dispatch, Pause
- Actions: add, kill, pause, resume, priority_bump

**Language** (language/block-types.md Lines 332-387) shows:
