...
|-----------|---------|--------|---------------|
| `|W.*` | Runtime wrappers | ✓ Fully documented | [Runtime Wrappers](runtime-wrappers.md) |
| `|Q.*` | Queue control | ✓ Fully documented | [Queue Control](queue-control.md) |
| `|Y.*` | Join operations | ✓ Fully documented | [Join Operations](join-operations.md) |
...
| Namespace | Purpose | Status | Documentation |
|-----------|---------|--------|---------------|
| `|U.*` | Utility functions | ⚠ Catalog only (APIs TBD) | [Utilities](utilities.md) |
| `|T.*` | Trigger patterns | ⚠ Catalog only (APIs TBD) | [Triggers](triggers.md) |
...
**Full Documentation:** [Runtime Wrappers](runtime-wrappers.md)
...
**Full Documentation:** [Queue Control](queue-control.md)
...
**Full Documentation:** [Join Operations](join-operations.md)
...
**Full Documentation:** [Utilities Catalog](utilities.md)
...
**Full Documentation:** [Triggers Catalog](triggers.md)
...
- [Runtime Wrappers (|W.*)](runtime-wrappers.md) - Complete reference
- [Queue Control (|Q.*)](queue-control.md) - Complete reference
- [Utilities (|U.*)](utilities.md) - Catalog
- [Triggers (|T.*)](triggers.md) - Catalog
- [Join Operations (|Y.*)](join-operations.md) - Complete reference
- [Reserved Enumerations](reserved-enumerations.md) - Schemas (deferred)

### Language Specification
- [Block Markers](../language/block-markers.md) - `[W]`, `[Q]`, `[t]`, `[Y]`
- [Operators](../language/operators.md) - `|` pipeline operator
- [Enumerations](../language/enumerations.md) - Reserved enumerations
