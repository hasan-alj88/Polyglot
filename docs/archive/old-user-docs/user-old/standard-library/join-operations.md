...
See [Block Markers](../language/block-markers.md) and [Parallel Execution](../language/parallel-execution.md) for complete details.
...
- [Parallel Execution](../language/parallel-execution.md) - Complete parallel execution documentation
- [Block Markers](../language/block-markers.md) - `[Y]` and `[p]` block markers
- [Expansion Operator](../language/expansion-operator.md) - Using `[~]` with parallel blocks
- [Standard Library Overview](overview.md) - Complete stdlib organization

---

**Navigation:**
← [Triggers Catalog](triggers-catalog.md) | [Standard Library Index](overview.md) | [Examples →](../examples/index.md)