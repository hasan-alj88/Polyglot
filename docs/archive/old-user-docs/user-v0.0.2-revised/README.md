...
### 🚀 Getting Started
- **New to Polyglot?** Start with [Quick Start Guide](language/quick-start.md) *(coming in future version)*
- **Language Overview:** See [Complete Syntax Reference](language/syntax-complete.md)
...
- [Complete Syntax Reference](language/syntax-complete.md) - All syntax in one place
- [Type System](language/type-system.md) - Types, literals, and type safety
- [Enumerations](language/enumerations.md) - Enumeration system and reserved enumerations
- [Error Handling](language/error-handling.md) - !Error types and error handling patterns
- [Operators](language/operators.md) - All operators: |, ~, @, #, !, <<, >>
- [Block Markers](language/block-markers.md) - Block elements: [|], [i], [r], [p], etc.
- [DateTime System](language/datetime-system.md) - DT literals and calendar support
- [Parallel Execution](language/parallel-execution.md) - Parallel blocks and join operations
- [Expansion Operator](language/expansion-operator.md) - [~] nesting and scope rules
- [Pipeline Lifecycle](language/pipeline-lifecycle.md) - Instances, execution, and queues
- [Comments](language/comments.md) - Comment syntax and conventions

#### Standard Library Reference
Built-in pipelines, utilities, and system enumerations.

- [Overview](standard-library/overview.md) - Standard library organization
- [Runtime Wrappers](standard-library/runtime-wrappers.md) - |W.* for Python, Node, Rust, etc.
- [Queue Control](standard-library/queue-control.md) - |Q.* queue operations
- [Utilities](standard-library/utilities.md) - |U.* utilities catalog
- [Triggers](standard-library/triggers.md) - |T.* trigger patterns catalog
- [Join Operations](standard-library/join-operations.md) - |Y.* join operations
- [Reserved Enumerations](standard-library/reserved-enumerations.md) - #Path, #Queues, #DT, #Status *(deferred)*
...
- [Workflow Overview](cli/workflow.md) - Compile → Register → Activate
- [polyglot compile](cli/compile.md) - Compile Polyglot code to IR
- [polyglot register](cli/register.md) - Register packages
- [polyglot activate](cli/activate.md) - Activate pipelines for monitoring
- [polyglot test](cli/test.md) - Test pipelines *(methodology TBD)*

#### Package Management
Package system and registry reference.

- [Package Overview](packages/overview.md) - Package system overview
- [Registries](packages/registries.md) - Local, Community, Company registries
- [Creating Packages](packages/creating-packages.md) - How to create packages
- [Importing Packages](packages/importing-packages.md) - How to use packages

#### Architecture
Implementation details for compiler and runtime developers.

- [Architecture Overview](architecture/overview.md) - System architecture
- [Database Schema](architecture/database-schema.md) - IR storage design
...
- [Trigger Monitoring](architecture/trigger-monitoring.md) - Trigger system
- [Runtime Execution](architecture/runtime-execution.md) - Execution model
...
**For Beginners:**
1. Start with [Complete Syntax Reference](language/syntax-complete.md)
2. Review [Hello World Examples](examples/hello-world.md)
3. Explore [Type System](language/type-system.md)
4. Learn [Error Handling](language/error-handling.md)
5. Try [Data Processing Examples](examples/data-processing.md)

**For Intermediate Users:**
1. Master [Parallel Execution](language/parallel-execution.md)
2. Understand [Pipeline Lifecycle](language/pipeline-lifecycle.md)
3. Learn [Queue Control](standard-library/queue-control.md)
4. Explore [Runtime Wrappers](standard-library/runtime-wrappers.md)
5. Study [Complete Workflows](examples/complete-workflows.md)

**For Advanced Users:**
1. Deep dive into [Expansion Operator](language/expansion-operator.md)
2. Study [Architecture Documentation](architecture/overview.md)
3. Review [IR Representation](architecture/ir-representation.md)
4. Understand [Queue System Architecture](architecture/queue-system.md)

### By Use Case

**Automation Workflows:**
- [Triggers](standard-library/triggers.md) - Time and event triggers
- [Queue Control](standard-library/queue-control.md) - Execution management
- [Complete Workflows](examples/complete-workflows.md) - Full examples

**Multi-Language Integration:**
- [Runtime Wrappers](standard-library/runtime-wrappers.md) - Python, Node, Rust, etc.
- [Package System](packages/overview.md) - Code organization

**Data Processing:**
- [Type System](language/type-system.md) - Data types
- [Parallel Execution](language/parallel-execution.md) - Concurrent processing
- [Data Processing Examples](examples/data-processing.md) - Patterns

**Error Handling & Reliability:**
- [Error Handling](language/error-handling.md) - !Error types
- [Error Handling Examples](examples/error-handling.md) - Patterns
- [Queue Control](standard-library/queue-control.md) - Pause/resume
...
- See [Pipeline Lifecycle](language/pipeline-lifecycle.md) for complete terminology
...
- Language Questions: Refer to [Complete Syntax Reference](language/syntax-complete.md)
