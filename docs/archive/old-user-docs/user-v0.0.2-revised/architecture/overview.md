...
- [Type System](../language/type-system.md) - Type specification

### Other Architecture Documents
- [Database Schema](./database-schema.md) - IR storage design
- [IR Representation](./ir-representation.md) - Type system & IR structure
...
- [Database Schema](./database-schema.md) - Complete IR storage design
- [IR Representation](./ir-representation.md) - Type system details
- [BNF Grammar](../language/bnf/polyglot grammer.md) - Language specification
- [Standard Library](../standard-library/overview.md) - Built-in pipelines
