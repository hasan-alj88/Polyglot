...
**Note:** See [Pipeline Lifecycle](../language/pipeline-lifecycle.md) for detailed state information.
...
- [Pipeline Lifecycle](../language/pipeline-lifecycle.md) - Lifecycle states and system queues
- [Standard Library Overview](overview.md) - Complete stdlib organization
- [Join Operations](join-operations.md) - Synchronization with `|Y.*`

---

**Navigation:**
← [Runtime Wrappers](runtime-wrappers.md) | [Standard Library Index](overview.md) | [Utilities Catalog](utilities-catalog.md) →