...
1. **[Language Guide](./language/syntax-complete.md)** - Learn Polyglot's `.pg` syntax
2. **[Pipeline Tutorial](./tutorials/pipelines.md)** - Build automated workflows
3. **[Architecture Overview](./architecture/overview.md)** - Understand the 3-service design
...
3. **Resource-Aware Batch Processing**
   ...
   - See: [Queue System Guide](./architecture/queue-system.md)
...
- [Complete Syntax Guide](./language/syntax-complete.md) - All block markers, operators, and patterns
- [Pipeline Tutorial](./tutorials/pipelines.md) - Step-by-step pipeline building
- [Trigger Catalog](./standard-library/triggers.md) - All available trigger types
