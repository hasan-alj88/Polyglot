...
**Status:** DEPRECATED - See docs/user/ai-quick-reference.md for current version

---
**⚠️ DEPRECATION NOTICE (2025-12-03):** This is an old backup file. It contains outdated syntax including operator directionality violations. For current quick reference, see `docs/user/ai-quick-reference.md` and `docs/user/syntax/operators.md` (v0.0.6).
---
...
[i] .constant: pg\string << "value"   // Immutable
[i] .optional: pg\int <~ 30         // Optional with default
...
```polyglot
pg\serial       // Serializable data (dynamic schema)
...
| `Fixed` | Immutable input | `[i] .key: pg\string << "secret"` |
| `Default` | Optional input with default | `[i] .timeout: pg\int <~ 30` |
