...
2. `/docs/user/examples/approved-examples.md`
3. `/docs/user/language/syntax-complete.md` (lines 1190-1230)
...
- [Complete Syntax Reference](language/syntax-complete.md) - Canonical syntax
- [Block Markers](language/block-markers.md) - All block markers
