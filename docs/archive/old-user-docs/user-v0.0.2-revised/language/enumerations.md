...
- [Type System](type-system.md) - Enumeration types details
- [Complete Syntax Reference](syntax-complete.md) - `[#]` block marker
- [Error Handling](error-handling.md) - Error types (special enumerations)

### Standard Library
- [Reserved Enumerations](../standard-library/reserved-enumerations.md) - Complete schema reference
