...
<macro-scope-input> ::= "[{]" <field-name> ":" <type>
...
/* EXACTLY ONE wrapper - REQUIRED in canonical form
   Default |W.Polyglot.Scope inserted if missing */
...
IF count = 0
  THEN INSERT: [W] |W.Polyglot.Scope
...
[i] .input: pg\string
[t] |T.Call
[W] |W.Polyglot.Scope  // ← INSERTED BY COMPILER
[r] |DoStuff
[X]
```
...
[t] |T.Call                  // 2. Trigger
[W] |W.Polyglot.Scope     // 3. Wrapper (inserted)
...
2. **Default Insertion**
   ...
   - Insert `[W] |W.Polyglot.Scope` if needed
...
- [Complete Syntax Reference](syntax-complete.md) - High-level syntax guide
- [Type System](type-system.md) - Type semantics and rules
- [Operators](operators.md) - Operator semantics
- [Block Markers](block-markers.md) - Block marker reference
