...
**VALID:**
```aljam3
{ } file-01.jm3 — full mesh: references both other files
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-02.jm3"
   [@] << "{.}\file-03.jm3"

{ } file-02.jm3 — full mesh: references both other files
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-01.jm3"
   [@] << "{.}\file-03.jm3"

{ } file-03.jm3 — full mesh: references both other files
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-01.jm3"
   [@] << "{.}\file-02.jm3"
...
[ ] ✓ folder shorthand expands to all .jm3 files in directory
```

**INVALID:**
```aljam3
{ } file-01.jm3 — references file-02
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-02.jm3"

{ } file-02.jm3 — does NOT reference file-01 back
{@} @Local:1000.MyApp:v1.0.0
   [ ] ✗ PGE09010 — file-02.jm3 does not reference file-01.jm3 (asymmetric)
```

```aljam3
{ } file-01.jm3 — references both
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-02.jm3"
   [@] << "{.}\file-03.jm3"

{ } file-02.jm3 — references both
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-01.jm3"
   [@] << "{.}\file-03.jm3"

{ } file-03.jm3 — only references file-01, missing file-02
{@} @Local:1000.MyApp:v1.0.0
   [@] << "{.}\file-01.jm3"
   [ ] ✗ PGE09010 — file-03.jm3 does not reference file-02.jm3
```
