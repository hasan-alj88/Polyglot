...
**See also:** PGE09001 (undefined import alias — validates the `@alias` prefix), PGE09003 (unresolved pipeline reference — same concept for local/jm3lib pipelines), PGE01010 (pipeline IO name mismatch — validated after the pipeline reference resolves)
