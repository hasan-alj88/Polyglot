...
**Detection:** The compiler checks each `[!]` block's parent `[-]` call. If the called pipeline has no `(-) !...` declarations (and is not a jm3lib failable pipeline), PGW07001 fires.
