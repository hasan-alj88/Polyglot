...
**Named `##` schemas:** ##Leaf, ##Scalar, ##Flat (depth); ##Inf (value); ##Sorted (structure); ##Enum (classification); ##Fields, ##Nullable, ##Result, ##String, ##Record, ##Array, ##Dataframe (parameterized). *Retired (#275):* ##Map, ##Set, ##Contiguous, ##Sparse, ##Rectangular, ##Deep.

**`%##` properties (branch-level):** %##Fields (#FieldsDescriptor or ##Enum ref), %##Schema (list of ##), %##Active (#ActiveKind), %##Ordered (#Boolean), %##Sorted (#Boolean), %##Gap (#Boolean), %##Count (#Bound), %##Count.Min (#uint), %##Propagate (#Boolean), %##Level.N (scope), %##Depth.Max (#Bound), %##Alias (#NestedKeyString). *Retired (#275):* %##Flexible (#FlexKind), %##Key, %##Range, %##Regular.
