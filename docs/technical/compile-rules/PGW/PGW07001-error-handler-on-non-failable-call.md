...
**Detection:** The compiler checks each `[!]` block's parent `[r]` call. If the called pipeline has no `[=] !...` declarations (and is not a stdlib failable pipeline), PGW07001 fires.
