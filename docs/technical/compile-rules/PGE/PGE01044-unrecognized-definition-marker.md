...
**Rationale:** Aljam3 has a strict set of valid definition markers (`{-}`, `{#}`, `{T}`, etc.). An unknown character inside curly braces indicates a typo or an unsupported marker.
