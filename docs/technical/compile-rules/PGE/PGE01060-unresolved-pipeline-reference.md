...
**Rationale:** Polyglot requires all dependencies to be statically resolvable at compile time. This prevents runtime "command not found" errors and ensures that the dependency graph is fully known before execution begins.
