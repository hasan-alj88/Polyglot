...
**See also:** PGE03004 (section-boundary pairing for `[p]`/`[*]`), PGE03007 (expand operator input mismatch), PGE03008 (collect operator IO mismatch)
...
[p] ~ForEach.Array
   ...
   [p] ~ForEach.Array                        [ ] ✗ PGE03009 — no collector for inner expand
      [~] <Array << $outerItem
      [~] >item >> $innerItem
