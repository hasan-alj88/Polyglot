...
**Detection:** The compiler maintains a list of reserved stdlib namespace prefixes. Each `[@]` alias is checked against this list. If the alias matches (case-sensitive), PGE-913 fires.

**See also:** PGE-901 (undefined import alias), PGE-912 (duplicate import alias), packages.md (stdlib pipelines don't require import)
...
**INVALID:**
```polyglot
[ ] ✗ PGE-913 — @T shadows stdlib namespace =T.*
{@} @Local:999.MyApp:v1.0.0
   [@] @T << @Local:999.CustomTriggers:v1.0.0   [ ] ✗ PGE-913 — T is a reserved stdlib namespace
...
```polyglot
[ ] ✗ PGE-913 — @File shadows stdlib namespace =File.*
{@} @Local:999.MyApp:v1.0.0
   [@] @File << @Local:999.FileUtils:v1.0.0     [ ] ✗ PGE-913 — File is a reserved stdlib namespace
```

```polyglot
[ ] ✗ PGE-913 — @W shadows stdlib namespace =W.*
{@} @Local:999.MyApp:v1.0.0
