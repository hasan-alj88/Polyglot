...
[r] $data << "override"           [ ] ✗ PGE03001 — push across parallel boundary
...
- [[concepts/collections/collect|Collect]] — documents pull isolation constraint for `[p]` outputs (references PGE03003)
