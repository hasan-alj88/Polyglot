...
**Rationale:** The Aljam3 compiler strictly enforces hierarchical semantics by ensuring structural markers define the entire line's behavior. Allowing markers mid-expression creates severe ambiguity for execution engines and destroys the visual layout consistency of the language.
