...
| [06-operators.md](06-operators.md) | S6. Operators | EC-6.1--6.6 |
...
| S6 Operators | EC-6.1--6.6 | All assignment ops, all comparison ops, range ops, `range_open` lexer disambiguation, arithmetic banned (PGE04010), fallback validity |
...
| S10 Execution | EC-10.1--10.20 | Pipeline call + error, jm3lib call, chain execution, chain IO, chain auto-wire, chain errors, serial load, parallel, effectless exec_expr, orphan continuation, self-chain, foreign code, wildcard auto-wire (valid + PGE08001/02/03) |
