...
{-} -Onboard.Employee
   ...
   [-] @HR-Record.Build->@HR-Record.Save
   ...
   [=] =ForEach.Array
      ...
      [?] $category:enabled =? #Boolean.True
         ...
         [-] =ForEach.Array
            ...
            [-] $label#string << "{$category:name}/{$leaf:name}"
