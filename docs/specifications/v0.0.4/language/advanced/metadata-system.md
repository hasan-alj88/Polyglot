...
[.] .enumfield                     // Regular field
[.] ;enumfield_reserved            // Reserved field (semicolon prefix!)
...
```polyglot
#;EnumDef.enumfield                // One semicolon (reserved enum, regular field)
#;EnumDef;enumfield_reserved       // TWO semicolons (reserved enum, reserved field)
```
...
[.] .CustomYear                    // User-defined field (no %Reserved)
{#}
```
