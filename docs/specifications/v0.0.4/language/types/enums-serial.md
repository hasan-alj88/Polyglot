...
**See:** [Reserved Indication System](../language/advanced/reserved-indication.md) for complete details on the semicolon system.
...
- [Serial Load Block](../language/advanced/serial-load-block.md) - `[s]` marker details
