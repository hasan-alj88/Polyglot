...
// Both forms work:
[y] $flag =? #pg.Boolean.True          // Explicit
[y] $flag =? #True                     // Aliased (requires import)
{x}
```
...
// Or explicit forms
[y] $active =? #pg.Boolean.True
[y] $optional =? #pg.Optional.None
{x}
```
...
// Usage
[y] $flag =? @Polyglot::Core#Boolean.True
```
...
[y] $authorized =? #True               // Reserved (via alias)
