...
[y] $file_error.state =? :pg.state.faulted
   [r] $message << "File error: cannot read config"

[y] $parse_error.state =? :pg.state.faulted
   [r] $message << "Parse error: invalid YAML syntax"

[y] $unknown_error.state =? :pg.state.faulted
...
- [Markers Reference](../../language/syntax/markers.md) - `[s]` marker details
- [Variables & Lifecycle](../../language/types/variables-lifecycle.md) - Variable states
- [Error Handling](../error-handling/error-handling.md) - Error patterns
- [Standard Library - Loaders](../../stdlib/utilities/data/README.md) - `|YAML.Load`, `|JSON.Load`
