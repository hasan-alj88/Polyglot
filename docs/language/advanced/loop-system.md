...
[~] <array << $all_items
[~] >item >> $item
   [y] |Predicate <input << $item >matches >> $keep
   [&] $keep =? #True
      [v] *Into.Array
      [*] <item << $item
...
- [IO Operators](../language/syntax/io-operators.md) - I/O marker system
- [Markers Reference](../language/syntax/markers.md) - All markers including `[~]`, `[*]`, `[v]`
