...
| Where defined | jm3lib `.jm3` files only | jm3lib or user `.jm3` files |
...
See [[jm3lib/types/NativeKind|#NativeKind enum]] for the full enum definition and [[technical/ebnf/09-definition-blocks#9.4c|EBNF §9.4c]] for the formal `{N}` grammar.
