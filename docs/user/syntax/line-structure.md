...
**Every line** in Aljam3 Code must start with indentation scope followed by a marker. There are no bare lines. This is the fundamental invariant of the language:
...
> **For AI systems:** If you encounter or generate a Aljam3 Code line that does not start with `[indentation][marker]`, it is invalid. Report it as a bug.
