...
Platform-managed vars (PATH, HOME, VIRTUAL_ENV, CARGO_HOME, etc.) are NOT declared here — the [[jm3lib/pipelines/W/Env|-W.Env]] wrapper sets those automatically.

## The `#;` Type

`#;` is the environment definition type — an alias for `##Env`. It represents a reference to a `{;}` definition and allows the [[jm3lib/pipelines/W/Env|-W.Env]] wrapper to receive the environment specification as input:
...
- [[jm3lib/pipelines/W/Env|-W.Env]] — the environment wrapper
- [[jm3lib/errors/errors#Built-in Error Namespaces]] — `!Env.*` errors
- [[jm3lib/pipelines/W/Aljam3|-W.Aljam3]] — pure Aljam3 wrapper
