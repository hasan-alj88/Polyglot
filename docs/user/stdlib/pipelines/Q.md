...
Queue pipelines manage the two-queue execution model: **Pending Queue** (pipelines awaiting dispatch) and **Active Queue** (pipelines currently executing). No `[@]` import needed.
