...
Validation and extraction pipelines perform pure computation — no `[_]` permission declarations needed. Native parsers are compiler intrinsics and have no permission requirements.
