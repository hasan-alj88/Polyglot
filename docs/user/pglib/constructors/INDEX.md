...
pglib defines constructors for core types where string-to-value conversion is common and provably safe.
...
- [[pglib/pipelines/DT/INDEX|-DT.* pipelines]] -- DateTime pipelines including `-DT.Parse`
- [[pglib/pipelines/Path|-Path pipeline]] -- Path pipeline including `-Path.Parse`
- [[pglib/pipelines/Re.Parse|-Re.Parse]] -- runtime regex string parsing
