...
- [[pglib/reassemblers/Into/Array|=*Into.Array]] -- collect into array
- [[pglib/reassemblers/Into/Map|=*Into.Map]] -- collect into map
- [[pglib/reassemblers/Into/Dataframe|=*Into.Dataframe]] -- collect into dataframe

## Related

- [[pglib/reassemblers/INDEX|Reassemble Operators overview]]
- [[pglib/collectors/Into/INDEX|*Into Collectors]] -- standalone collector equivalents
