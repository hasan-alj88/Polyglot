...
> **Supersedes:** `-RT.<Lang>.Function.Inline` and `-RT.<Lang>.Function.File`. See [[pglib/pipelines/RT/Function.Inline|@d:-RT.\<Lang\>.Function.Inline]] and [[pglib/pipelines/RT/Function.File|@d:-RT.\<Lang\>.Function.File]].
