...
- [[pglib/types/Variable|#Variable]] -- the language-tagged variable type
- [[pglib/types/NativeType|#NativeType]] -- marshalling table for type mapping
- [[pglib/pipelines/Run/Bridge.Function|-Run.Bridge.Function]] -- uses Convert internally
- [[pglib/pipelines/Run/Bridge.Script|-Run.Bridge.Script]] -- uses Convert internally
