...
| `<Strategy` | `#RotationKind` | `#RotationKind.Auto` | Detection strategy. See [[pglib/types/RotationKind\|#RotationKind]]. |
...
- [[pglib/pipelines/T/Folder.NewFiles|-T.Folder.NewFiles]] — related trigger (fires on new files, not rolled files)
- [[pglib/types/RotationKind|#RotationKind]] — detection strategy enum
