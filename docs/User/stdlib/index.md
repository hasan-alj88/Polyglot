...
**See:** [Inline Pipelines Complete Specification](../User/language/advanced/inline-pipelines.md)
...
**See:** [Pipeline Structure](../User/language/control-flow/pipeline-structure.md#trigger-t---required)
...
**See:** [Pipeline Structure](../User/language/control-flow/pipeline-structure.md#queue-q---optional)
...
- [Loop System](../User/language/advanced/loop-system.md) - Unpack/pack operators in detail
- [Pipeline Structure](../User/language/control-flow/pipeline-structure.md) - Triggers and wrappers
