...
|---------|--------|-------------|-------------|---------------|------------|
| v0.0.2 | 📦 Archived | Complete | Historical | [Archive](../../archive/old-user-docs/) | [Available](../../Tech/ai-context/v0.0.2/) |
...
- 🤖 [AI Context Package](../../Tech/ai-context/v0.0.2/) - 13 machine-readable files
...
- 📋 [Epic Breakdown](../../Agile/epics.md) - Implementation epics
- 📂 [Stories](../../Agile/stories/) - User stories for Epic 1
- 🔧 [Architecture](../../Tech/implementation/technical/architecture.md) - Technical design
...
- See [Sprint Status](../../Agile/stories/sprint-status.yaml)
...
- [AI Context v0.0.2](../../Tech/ai-context/v0.0.2/)
...
- Location: [ai-context/v0.0.2/](../../Tech/ai-context/v0.0.2/)
...
→ [AI Context Packages](../../Tech/ai-context/)
