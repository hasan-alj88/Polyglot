...
**Current:**
```polyglot
[f] .temperature ?[20, 25]      // Closed interval
   [r] .description << "comfortable"

[f] .temperature ?(25, 35)      // Open interval
   [r] .description << "warm"
```

**Proposed - Use familiar syntax:**
```polyglot
[f] .temperature >= 20 && .temperature <= 25
   [r] .description << "comfortable"

// Or introduce 'in' keyword:
[f] .temperature in 20..25      // Inclusive
   [r] .description << "comfortable"

[f] .temperature in 25..<35     // Exclusive end
   [r] .description << "warm"
```
