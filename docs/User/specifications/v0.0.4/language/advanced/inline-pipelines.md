...
- [Core Principles](../../User/getting-started/core-principles.md) - One line = one expression
...
- [Standard Library](../../User/stdlib/index.md) - All utilities support inline calls
