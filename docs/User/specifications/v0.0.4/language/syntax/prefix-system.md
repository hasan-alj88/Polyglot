...
**v0.0.4 uses dots (`.`) for reserved, semicolons (`;`) for custom:**

```polyglot
#Boolean.True                      // Fully reserved
#Boolean.False                     // Fully reserved
#OrderStatus.Processing            // User-defined
#DT.Business.Week;FiscalYear.Q1    // Mixed: reserved.reserved;custom.custom
```

**Syntax:**
- `.` - Reserved segment (dots indicate reserved)
- `;` - Custom/user-defined segment (semicolons indicate custom extensions)
...
- [Standard Library](../User/stdlib/index.md) - All standard pipelines
...
```polyglot
{#} #Boolean.True
[%] %Reserved << #Boolean.True     // ⚠️ Privileged operation
{x}
```

### See Also

- [Metadata System](../User/language/advanced/metadata-system.md) - Complete metadata guide
...
- [Metadata System](../User/language/advanced/metadata-system.md) - `%` prefix usage
