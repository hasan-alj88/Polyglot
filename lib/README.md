...
| Folder | Purpose |
|--------|---------|
| `Aljam3-Core/` | The Aljam3 compiler (Rust crate) — lexer, compiler, and the `.jm3` standard library (`jm3lib/`) |
...
- **Aljam3-Core** is the _implementation of the Aljam3 language itself_ — tokenizing `.jm3` source, validating it, and producing AST JSON. It happens to be written in Rust, but it _is_ Aljam3.
