...
Language-specific SDKs for integrating Polyglot into host-language codebases.

Each language folder provides packages for embedding Polyglot and implementing native operations.
...
| Package | Purpose |
|---------|---------|
| `integrator/` | Bidirectional SDK: call Polyglot + be called by Polyglot |
