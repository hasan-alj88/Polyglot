...
impl Aljam3Db {
    ...
    ///
    /// # Arguments
    /// * `database_url` - The connection string (e.g., "postgres://aljam3:aljam3@localhost/aljam3")
    ...
    /// Initializes the NoSQL DB by creating the fundamental JSONB tables for Aljam3.
