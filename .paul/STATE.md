...
- Issue #161: [██████████] 100% (5/5 plans — all jm3lib docs split into per-operator files)
...
- Issue #286: [██████████] 100% (1/1 plans — #Email jm3lib scalar subtype)
...
- Issue #342: [██████████] 100% (3/3 plans — jm3lib {$} constructors for core types)
...
| v0.2 milestone created with 4 phases | 2026-03-24 | Phases 9-12: Core Language & Type System, Operators & Control Flow, Pipelines & Concurrency, Package System & jm3lib |
| Arithmetic uses =Math.* jm3lib, not raw operators | 2026-03-24 | PGE04010 confirms raw +,-,*,/ are compile errors; spec reflects pipeline-based arithmetic |
| Removed speculative jm3lib items | 2026-03-24 | =T.Schedule/HTTP/File, =W.Rust/Node had zero usage; =T.Webhook confirmed from EDGE-CASES |
...
| Issue #85 — Document jm3lib pipeline permission declarations | 2026-03-25 | [_] permissions in all 7 jm3lib pipeline files; Permission column in INDEX.md; completes #80-#85 chain |
...
| Formalized #DateTime as jm3lib type | 2026-04-01 | 55 {#} types in datetime.md (22KB); multi-calendar, time units, cultural extensions |
| #WeekSystem Option A restructure | 2026-04-01 | Enum fields with nested .config#BusinessWeek; fixes PGE05005 violation |
| =DT.* jm3lib pipelines | 2026-04-01 | 40 {=} pipelines in DT.md; construction, conversion, arithmetic, comparison, formatting, business |
...
| Closed #121 — {N} native block type | 2026-04-04 | {N} block, #NativeKind enum, NativeKind.md, PGE01028 rewritten, 44 jm3lib defs converted; merged to main |
...
| Closed #140 — {_} permission object block | 2026-04-05 | 3 plans: user docs (5), EBNF+metadata (6), compile rules+jm3lib (13); {_} named objects replace inline [_]; _/__/___ tiers; Ceiling vs Grant intent; PGE10005 renamed |
...
| Closed #135 — !Error extensibility contradiction | 2026-04-05 | User {!} !Name implicitly creates !Error:Name.*; replaced misleading examples; jm3lib table 7→10 namespaces; EBNF [:] grammar added |
...
| Closed #153 — =#.Column prefix collision | 2026-04-06 | Documented =#.* as valid jm3lib namespace in identifiers.md and #.md |
...
| Closed #161 — Split all jm3lib docs per operator | 2026-04-07 | Merged docs/issue-161-split-jm3lib-docs-per-operator to main; 125 files, 5 plans |
...
| Issue #273 — Three-bracket system complete | 2026-04-09 | 5 plans, 387 files: EBNF grammar, core docs, compile rules, jm3lib, remaining technical; {X} define, [X] control, (X) IO |
...
| Closed #286 — Add #Email string subtype to jm3lib | 2026-04-16 | Promoted #emailAddress from user-defined to jm3lib; alias "email"; 9 files updated |
...
| Issue #342 — jm3lib {$} constructors complete | 2026-04-22 | 3 plans: Tier 1 ($DT,$Path), Tier 2a ($Re,$MIME,$Dur), Tier 2b ($Ver,$URL,$IP,$Color); 9 constructors, 4 type defs, 9 parse pipelines, INDEX registry |
| Closed #342 — jm3lib {$} constructors for core types | 2026-04-22 | Merged design/issue-342-jm3lib-constructors-core-types to main |
...
- 9 jm3lib files remain status: draft despite Stable content (Math, Path, Sys, ForEach, collectors, types)
