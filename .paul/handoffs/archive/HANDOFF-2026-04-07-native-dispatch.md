...
**Context:** Designed native dispatch spec, created lib/ scaffold, renamed stdlib→aj3lib, began aj3lib .pg source files
...
- Created **lib/Polyglot/aj3lib/** with actual `.pg` source files organized by subsystem kind:
...
- **Renamed stdlib → aj3lib** — physical folder move + ~190 text replacements across 70+ files, file renames (STDLIB.md → AJ3LIB.md, PGE09012, phase folders, memory files)
...
| stdlib renamed to aj3lib | "aj3lib" = Polyglot library, clearer identity | 190+ occurrences updated; folder moved; all wikilinks updated |
| aj3lib .pg source files live in `lib/Polyglot/aj3lib/` | Organized by subsystem kind (tm/, qh/, runner/, intrinsics/) | Compiler reads these as source of truth for native definitions |
...
**Notes:** User wants `docs/user/aj3lib/pipelines/DT.md` (692 lines, 37 pipelines) split into `DT/` folder with one `.md` per pipeline definition
**Effort:** Medium — 37 files + INDEX.md + wikilink updates
**Reference:** `@docs/user/aj3lib/pipelines/DT.md`
...
**Reference:** `@docs/user/aj3lib/pipelines/`
...
**Reference:** `@docs/user/aj3lib/types/NativeKind.md:65-71`, `@docs/user/concepts/pipelines/INDEX.md:132-138`, `@docs/technical/compile-rules/PGE/PGE01028-base-derived-mutual-exclusion.md`

### DT.md `[%] .version` Lines in {N} Blocks
**Status:** REVIEW
**Notes:** The .pg files in `lib/Polyglot/aj3lib/runner/datetime.pg` don't include `.version` metadata. DT.md had `[%] .version << "1.0.0"` on every {N} block. Need to decide: is `.version` valid on {N} blocks? EBNF §9.4c `native_field` only lists `.Kind`, `.<Language>`, `.description`.
...
2. **GitHub issue labels**: What labels to use? (e.g., `aj3lib`, `native-impl`, `rust`, `spec`)
...
```
@docs/user/aj3lib/pipelines/DT.md              — file to split
@docs/user/aj3lib/pipelines/File.md             — template candidate
@docs/user/aj3lib/pipelines/Math.md             — template candidate
@docs/user/aj3lib/pipelines/Q.md                — template candidate
@docs/user/aj3lib/pipelines/T.md                — template candidate
@docs/user/aj3lib/pipelines/W.md                — template candidate
@docs/user/aj3lib/pipelines/#.md                — template candidate
@docs/user/aj3lib/pipelines/RT.md               — template candidate
@docs/technical/spec/native-dispatch.md         — dispatch spec (just written)
@lib/Polyglot/aj3lib/                           — .pg source files
...
**Current:** Post v0.2 — native dispatch architecture designed, lib/ scaffold created, aj3lib rename complete
