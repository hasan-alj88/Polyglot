...
plan: 01
subsystem: docs
tags: [packages, imports, stdlib, triggers, queues, wrappers, file-ops, errors, compile-rules]
...
# Phase 12 Plan 01: Package System & Stdlib Spec Completion

**Completed packages.md with 15 compile rules (13 PGE + 2 PGW), resolved all speculative stdlib markers, and promoted 7 files from draft to complete — closing v0.2 Language Specification.**
...
| AC-3: Stdlib pipeline specs complete (T, Q, W, File) | Pass | T.md: removed 3 speculative namespaces, confirmed =T.Webhook; W.md: removed 2 speculative wrappers; Q.md and File.md: status promoted with cross-refs added |
| AC-4: Stdlib errors spec complete | Pass | errors.md promoted to complete — content was already fully specified |
...
| docs/user/stdlib/pipelines/W.md | Modified | Removed speculative =W.Rust/Node, added PRIMITIVE note and cross-refs; status → complete |
| docs/user/stdlib/pipelines/File.md | Modified | Added cross-ref to errors spec; status → complete |
| docs/user/stdlib/errors/errors.md | Modified | Status → complete |
...
---
*Phase: 12-package-system-stdlib, Plan: 01*
*Completed: 2026-03-24*
