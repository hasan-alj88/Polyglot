...
plan: 02
subsystem: docs
tags: [datetime, jm3lib, types, calendar, multi-calendar]
requires:
  - phase: none
    provides: n/a
provides:
...
affects: [95-03, future jm3lib work]
key-files:
  created: [docs/user/jm3lib/types/datetime.md]
key-decisions:
...
| File | Change | Purpose |
|------|--------|---------|
| docs/user/jm3lib/types/datetime.md | Created | 55 {#} type definitions — main #DateTime, core components, enums, calendar dates, time units, cultural types |
