...
plan: 03
subsystem: docs
tags: [datetime, jm3lib, pipelines, compile-rules]
requires:
  - phase: 95-01
...
affects: [future jm3lib work, compiler implementation]
key-files:
  created: [docs/user/jm3lib/pipelines/DT.md, docs/technical/compile-rules/PGE/PGE04026-invalid-iana-timezone.md, docs/technical/compile-rules/PGE/PGE04027-missing-required-datetime-subfield.md, docs/technical/compile-rules/PGE/PGE04028-invalid-epoch-value.md]
  modified: [docs/technical/COMPILE-RULES.md, docs/user/jm3lib/INDEX.md]
key-decisions:
...
| File | Change | Purpose |
|------|--------|---------|
| docs/user/jm3lib/pipelines/DT.md | Created | 40 {=} pipeline definitions |
...
| docs/user/jm3lib/INDEX.md | Modified | Added #DateTime type + =DT.* pipeline entries |
