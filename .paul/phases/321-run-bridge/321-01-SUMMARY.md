...
key-files:
  created:
    ...
    - docs/user/jm3lib/types/Variable.md
    - docs/user/jm3lib/pipelines/Variable/Convert.md
...
| File | Change | Purpose |
|------|--------|---------|
| docs/user/jm3lib/types/NativeType.md | Created | Per-language native type enum for marshalling |
| docs/user/jm3lib/types/Variable.md | Created | Language-tagged variable type (.name, .value, .type) |
| docs/user/jm3lib/pipelines/Variable/Convert.md | Created | Cross-language variable conversion pipeline |
| docs/user/jm3lib/pipelines/Run/Bridge.Function.md | Created | Cross-language function call pipeline |
| docs/user/jm3lib/pipelines/Run/Bridge.Script.md | Created | Cross-language variable binding pipeline |
| docs/technical/algorithms/bridge-conversion.md | Created | Bridge conversion algorithm and dual-wrapper lifecycle |
| docs/user/jm3lib/pipelines/Run/INDEX.md | Modified | Added Bridge entries to pipeline index |
