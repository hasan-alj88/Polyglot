...
key-files:
  created: []
  modified:
    - docs/user/jm3lib/errors/builtin/*.md (13 files)
    - docs/user/jm3lib/types/scalars/*.md (9 files)
    - docs/user/jm3lib/types/datetime/calendars/*.md (11 files)
...
| CSV, Env, Storage, Text errors treated as top-level `%!` namespaces | They use `{!} !Name` syntax identical to FULL-TREE.md built-ins | Extends the `%!` namespace pattern for jm3lib additions |
