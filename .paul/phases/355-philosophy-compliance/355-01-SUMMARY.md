...
- Applied bold on first use of key terms (Failed, Accountability Chain, zero-trust, jm3lib, compile loop, black box)
...
| extensibility.md | Added @c:philosophy/language-design, glossary import + 2 term links, bold jm3lib |
