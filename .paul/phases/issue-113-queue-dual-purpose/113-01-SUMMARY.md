...
| AC-2: queue.md documents pipeline operation form | Pass | New section with disambiguation rule + 4 stdlib examples |
...
- Added "Queue Pipeline Operations (`{Q} =Q.*`)" section to queue.md with all 4 stdlib queue pipelines (`=Q.Default`, `=Q.Pause.Hard`, `=Q.Resume`, `=Q.Kill.Graceful`)
