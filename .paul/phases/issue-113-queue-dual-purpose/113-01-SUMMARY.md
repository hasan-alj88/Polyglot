...
| AC-2: queue.md documents pipeline operation form | Pass | New section with disambiguation rule + 4 pglib examples |
...
- Added "Queue Pipeline Operations (`{Q} =Q.*`)" section to queue.md with all 4 pglib queue pipelines (`=Q.Default`, `=Q.Pause.Hard`, `=Q.Resume`, `=Q.Kill.Graceful`)
