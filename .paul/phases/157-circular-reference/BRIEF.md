...
| `docs/user/pglib/collectors/Continue.md` | References PGE04009 as the rule mandating `*Continue >FallBack` for serial-to-struct conversion, closing the loop |
...
> - [[pglib/collectors/Continue|*Continue]] -- `*Continue >FallBack` usage for unproven conversions

**Source C** (`docs/user/pglib/collectors/Continue.md`, line ~46):
