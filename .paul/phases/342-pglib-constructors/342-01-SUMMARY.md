...
plan: 01
subsystem: pglib
tags: [constructors, datetime, path, pglib, compile-time]
...
provides:
  ...
  - "pglib constructors/ directory with registry INDEX"
...
key-files:
  created:
    ...
    - docs/user/pglib/constructors/DT.md
    - docs/user/pglib/constructors/Path.md
    - docs/user/pglib/pipelines/DT/Parse.md
    - docs/user/pglib/pipelines/Path.Parse.md
  modified:
...
**Defined $DT (7 overloads) and $Path (3 overloads) constructors with companion -DT.Parse/-Path.Parse runtime pipelines, establishing the pglib constructors/ directory**
...
- Established `docs/user/pglib/constructors/` as the pglib constructor catalog with registry INDEX
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/pglib/constructors/INDEX.md` | Created | Constructor registry with $DT and $Path entries |
| `docs/user/pglib/constructors/DT.md` | Created | $DT constructor — 7 overloads with regex, type binding, field mapping |
| `docs/user/pglib/constructors/Path.md` | Created | $Path constructor — 3 overloads with OS-aware path handling |
| `docs/user/pglib/pipelines/DT/Parse.md` | Created | -DT.Parse runtime pipeline for dynamic datetime strings |
| `docs/user/pglib/pipelines/Path.Parse.md` | Created | -Path.Parse runtime pipeline for dynamic path strings |
| `docs/user/pglib/pipelines/DT/INDEX.md` | Modified | Three-Context Rule table, -DT.Parse added to Construction listing |
| `docs/user/pglib/pipelines/Path.md` | Modified | Three-Context Rule section with constructor and parse pipeline refs |
...
---
*Phase: 342-pglib-constructors, Plan: 01*
*Completed: 2026-04-22*
