...
| `docs/user/aj3lib/types/types.md` | Line 32: `#Array:ValueType:Dim` uses PascalCase in type hierarchy display |
| `docs/user/aj3lib/types/collections.md` | Uses both `#Array` (section headers, macro defs) and `#array` (usage examples) — correct but potentially confusing without explanation |
...
**Source C** (`docs/user/aj3lib/types/collections.md`, line ~105):
> [#] %##Alias
