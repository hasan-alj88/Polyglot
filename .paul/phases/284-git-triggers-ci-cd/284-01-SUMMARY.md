...
key-files:
  created:
    ...
    - docs/user/jm3lib/pipelines/T/Git.Hook.md
    - docs/user/jm3lib/pipelines/T/Git.Push.md
    - docs/user/jm3lib/pipelines/T/Git.PR.md
    - docs/user/jm3lib/pipelines/T/Git.Tag.md
  modified:
...
|-----------|--------|-------|
| AC-1: Git trigger pipeline docs follow jm3lib template | Pass | All 4 triggers have {N} native def, IO tables, permissions, metadata |
...
- Documented 4 trigger pipelines following exact jm3lib template pattern (Git.Hook, Git.Push, Git.PR, Git.Tag)
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/jm3lib/types/git.md` | Created | #Git type tree — all Git event payload types |
| `docs/user/jm3lib/pipelines/T/Git.Hook.md` | Created | Local git hook transport trigger |
| `docs/user/jm3lib/pipelines/T/Git.Push.md` | Created | Semantic push event trigger with filters |
| `docs/user/jm3lib/pipelines/T/Git.PR.md` | Created | Semantic PR event trigger (remote only) |
| `docs/user/jm3lib/pipelines/T/Git.Tag.md` | Created | Semantic tag creation trigger with pattern filter |
| `docs/user/jm3lib/pipelines/T/INDEX.md` | Modified | Added 4 triggers to listing + permissions + three-tier model |
...
| Assume #email exists (per #286) | Created issue #286 for jm3lib #Email; used in #Git.Author.email | git.md depends on #286 being completed |
