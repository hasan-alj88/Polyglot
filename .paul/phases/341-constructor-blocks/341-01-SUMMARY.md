...
affects: [341-02-ebnf-metadata, 342-pglib-constructors, 343-compile-rules, 344-doc-updates]
...
- No boundary violations: zero PGE/PGW codes, zero pglib definitions
...
| %InlineString retired from {-} only | Triggers/queues/wrappers still need inline config; only execution body use is replaced | Clean separation; #344 can update pglib docs |
