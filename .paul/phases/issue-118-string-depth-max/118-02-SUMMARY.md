...
### Task 1: Stdlib scalar enum types — ###Enum → ###ScalarEnum
...
### Task 2: Stdlib scalar value types — ###Value → ###ScalarValue
...
1. docs/user/stdlib/types/boolean.md
2. docs/user/stdlib/types/enums.md
3. docs/user/stdlib/types/BaseCode.md
4. docs/user/stdlib/types/string.md
5. docs/user/stdlib/types/scalars.md
6. docs/user/stdlib/types/structs.md
7. docs/user/stdlib/types/types.md
8. docs/user/stdlib/types/collections.md
9. docs/user/stdlib/types/datetime/main-type.md (not modified — ###Value retained, non-scalar)
10. docs/user/stdlib/types/datetime/core-components.md
11. docs/user/stdlib/types/datetime/calendar-date-types.md
12. docs/user/stdlib/types/datetime/calendar-infrastructure.md
13. docs/user/stdlib/types/datetime/cultural-types.md
14. docs/user/stdlib/types/datetime/non-standard-time.md
15. docs/user/stdlib/types/datetime/supporting-enums.md
