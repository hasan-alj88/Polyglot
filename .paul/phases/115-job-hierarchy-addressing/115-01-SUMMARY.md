...
provides:
  ...
  - "=Q.Job.Branch pglib pipeline stub"
...
| AC-2: =Q.Job.Branch pglib pipeline documented | Pass | Q.md "Job Addressing" section |
...
| `docs/user/pglib/pipelines/Q.md` | Modified | Added "Job Addressing" section with `=Q.Job.Branch` |
