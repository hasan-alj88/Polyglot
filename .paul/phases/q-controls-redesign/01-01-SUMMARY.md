...
plan: 01
subsystem: docs
tags: [queue, pglib, Q-pipelines, controls-redesign]
...
provides:
  ...
  - Rewritten Q pipeline catalog (docs/user/pglib/pipelines/Q/INDEX.md)
...
| `docs/user/pglib/pipelines/Q/INDEX.md` | Rewritten | Full pipeline catalog with getters, state guards, actions, examples, deprecation table |
