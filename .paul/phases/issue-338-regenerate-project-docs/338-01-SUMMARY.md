...
- Plan boundaries observed: no changes to `docs/vision.md`, `docs/philosophy/*`, `docs/audit/**`, `docs/user/**`, `docs/technical/**`, or `docs/archive/**`. Only `docs/INDEX.md` edited for link rows. No new compile rules, EBNF edits, or pglib additions. No deletions.
