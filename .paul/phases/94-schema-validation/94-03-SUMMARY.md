...
key-files:
  modified:
    - docs/user/stdlib/expanders/ForEach/Dataframe.md
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/stdlib/expanders/ForEach/Dataframe.md` | Modified | Marked Column variant as deprecated, linked to =#.Column |
