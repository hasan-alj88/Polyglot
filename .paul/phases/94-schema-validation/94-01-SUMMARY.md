...
2. **docs/user/jm3lib/types/types.md** — Had `#Map<KeyType<ValueType` in type hierarchy listing
3. **docs/user/jm3lib/expanders/ForEach/Dataframe/Column.md** — Deprecated (row-oriented Dataframe breaks column expander)
