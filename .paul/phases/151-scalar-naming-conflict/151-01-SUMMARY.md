...
key-files:
  modified: [docs/user/jm3lib/types/scalars.md, docs/user/syntax/types/basic-types.md, docs/technical/spec/metadata-tree/string-subtypes.md]
key-decisions:
...
| File | Change | Purpose |
|------|--------|---------|
| docs/user/jm3lib/types/scalars.md | Modified | Naming convention table after opening paragraph |
