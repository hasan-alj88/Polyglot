...
| AC-5: INDEX.md and STDLIB.md updated | Pass | =RT row, =W description, !RT listing, #Code/#PyEnv/#RsEnv types |
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/stdlib/pipelines/RT.md` | Created | All 7 =RT.* execution pipelines (261 lines) |
| `docs/user/stdlib/types/rt.md` | Created | #Code, #PyEnv, #RsEnv type definitions (72 lines) |
| `docs/user/stdlib/pipelines/W.md` | Modified | =W.Python → =W.RT with flexible fields |
| `docs/user/stdlib/types/types.md` | Modified | Added Runtime category + types to hierarchy |
| `docs/user/stdlib/errors/errors.md` | Modified | Added {!} !RT block + pipeline associations |
| `docs/user/stdlib/INDEX.md` | Modified | Added =RT, !RT, #Code/#PyEnv/#RsEnv rows |
| `docs/user/STDLIB.md` | Modified | Added =RT link in pipeline section |
...
| <Bind#serial not #Map | Serial is Polyglot's universal exchange format | Consistent with rest of stdlib |
