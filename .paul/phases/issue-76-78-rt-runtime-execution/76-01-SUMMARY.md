...
| AC-5: INDEX.md and JM3LIB.md updated | Pass | =RT row, =W description, !RT listing, #Code/#PyEnv/#RsEnv types |
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/jm3lib/pipelines/RT.md` | Created | All 7 =RT.* execution pipelines (261 lines) |
| `docs/user/jm3lib/types/rt.md` | Created | #Code, #PyEnv, #RsEnv type definitions (72 lines) |
| `docs/user/jm3lib/pipelines/W.md` | Modified | =W.Python → =W.RT with flexible fields |
| `docs/user/jm3lib/types/types.md` | Modified | Added Runtime category + types to hierarchy |
| `docs/user/jm3lib/errors/errors.md` | Modified | Added {!} !RT block + pipeline associations |
| `docs/user/jm3lib/INDEX.md` | Modified | Added =RT, !RT, #Code/#PyEnv/#RsEnv rows |
| `docs/user/JM3LIB.md` | Modified | Added =RT link in pipeline section |
...
| <Bind#serial not #Map | Serial is Polyglot's universal exchange format | Consistent with rest of jm3lib |
