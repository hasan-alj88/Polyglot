...
affects: [12-package-system-jm3lib]
...
- Compile rule cross-references in place for Phase 12 (Package System & jm3lib)
- Phase 12 can reference pipelines.md for jm3lib pipeline definitions and errors.md for error tree contracts
