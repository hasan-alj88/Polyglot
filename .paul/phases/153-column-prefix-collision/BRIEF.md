...
**Source B** (`docs/user/pglib/pipelines/#.md`, line ~1-9):
> # =# -- Schema Validation & Field Extraction
>
> pglib pipelines for schema validation, field extraction, format parsing, and dataframe column extraction. No `[@]` import needed.
