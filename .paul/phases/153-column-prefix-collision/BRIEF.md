...
**Source B** (`docs/user/jm3lib/pipelines/#.md`, line ~1-9):
> # =# -- Schema Validation & Field Extraction
>
> jm3lib pipelines for schema validation, field extraction, format parsing, and dataframe column extraction. No `[@]` import needed.
