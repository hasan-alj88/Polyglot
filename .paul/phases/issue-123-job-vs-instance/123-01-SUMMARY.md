...
plan: 01
subsystem: docs
tags: [job, instance, metadata-tree, glossary, stdlib-types]

requires:
  - phase: none
    provides: existing glossary, structs.md, branches.md, data-is-trees.md
provides:
  - "{#} #Job stdlib struct type"
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/stdlib/types/structs.md` | Modified | Added `## #Job` section with definition, Fields table, context note |
