...
affects: [75-03 technical spec, 75-04 spec-wide migration, EBNF, compile-rules, jm3lib types]
...
|----------|-----------|--------|
| Full {#} definitions inline in types.md | Single source of truth for type hierarchy | Readers see complete definitions without jumping to jm3lib |
...
- jm3lib/types/types.md missing core type definitions (#String, #Int, #Array, #Dict, etc.) — include in Plan 75-03
