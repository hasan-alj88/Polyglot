...
plan: 03
subsystem: docs
tags: [type-system, ebnf, metadata-tree, compile-rules, stdlib, generics, schema-properties]
...
# Issue #75 Plan 03: Technical Spec + Stdlib Type Definitions

**Updated EBNF grammar, metadata tree, and compile rules for # type annotations; added all 11 core type definitions to stdlib types.md.**
...
- stdlib types.md has complete core type definitions — downstream files can reference
