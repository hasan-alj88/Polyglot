...
key-files:
  ...
  modified:
    ...
    - docs/user/pglib/pipelines/Q/INDEX.md
    - 15 action pipeline docs in docs/user/pglib/pipelines/Q/
...
| `docs/user/pglib/pipelines/Q/INDEX.md` | Modified | Source column added to 6 getter/state/idle tables |
| `docs/user/pglib/pipelines/Q/Job.Pause.Free.CPU.md` | Modified | Runtime Behavior: cgroup.freeze / SIGSTOP |
| `docs/user/pglib/pipelines/Q/Job.Pause.Free.RAM.md` | Modified | Runtime Behavior: .Soft (memory.high) and .Hard (memory.max) variants |
| `docs/user/pglib/pipelines/Q/Job.Pause.Free.All.md` | Modified | Runtime Behavior: CRIU dump |
| `docs/user/pglib/pipelines/Q/Job.Resume.md` | Modified | Runtime Behavior: type-aware routing (cgroup thaw vs criu restore) |
| `docs/user/pglib/pipelines/Q/Job.Kill.WithCleanup.md` | Modified | Runtime Behavior: teardown queue + SIGTERM + [/] cleanup |
| `docs/user/pglib/pipelines/Q/Job.Kill.Now.md` | Modified | Runtime Behavior: SIGKILL immediate |
| `docs/user/pglib/pipelines/Q/Job.Throttle.md` | Modified | Runtime Behavior: throttle (cpu.max/memory.high/io.max) + unthrottle |
| `docs/user/pglib/pipelines/Q/Job.Snapshot.md` | Modified | Runtime Behavior: criu dump --leave-running |
| `docs/user/pglib/pipelines/Q/Job.Inspect.md` | Modified | Runtime Behavior: Redis read-only, no Unix op |
| `docs/user/pglib/pipelines/Q/Job.Reassign.md` | Modified | Runtime Behavior: Lua script + optional CRIU for cross-host |
| `docs/user/pglib/pipelines/Q/Priority.Update.md` | Modified | Runtime Behavior: ZADD only |
| `docs/user/pglib/pipelines/Q/Queue.Drain.md` | Modified | Runtime Behavior: SADD queues:draining |
| `docs/user/pglib/pipelines/Q/Queue.Flush.md` | Modified | Runtime Behavior: per-job SIGKILL |
| `docs/user/pglib/pipelines/Q/DoNothing.md` | Modified | Runtime Behavior: no-op note |
| `docs/user/pglib/pipelines/Q/Dispatch.Wait.TimeOut.md` | Modified | Runtime Behavior: escalate + variant delegation |
