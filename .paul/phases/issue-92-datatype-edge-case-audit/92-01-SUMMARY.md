...
plan: 01
subsystem: docs
tags: [edge-cases, types, schema, %##, stdlib]
...
provides:
  ...
  - stdlib types/ split into 6 category files with correct notation
...
key-decisions:
  ...
  - "Rewrite all stdlib enums to {#} format with ##Scalar, ###Enum, %##Alias"
...
**18 edge cases documented for all datatype definitions; stdlib types/ split from 1 monolithic file into 6 category files with corrected notation.**
...
- Split monolithic stdlib types.md into string.md, scalars.md, boolean.md, collections.md, enums.md, structs.md
...
| docs/user/stdlib/types/types.md | Rewritten | Now index page with hierarchy + links |
| docs/user/stdlib/types/string.md | Created | #String foundation type |
| docs/user/stdlib/types/scalars.md | Created | 8 scalar subtypes |
| docs/user/stdlib/types/boolean.md | Created | #Boolean + #None |
| docs/user/stdlib/types/collections.md | Created | #Map, #Array, #Serial, #Dataframe (TBD) |
| docs/user/stdlib/types/enums.md | Created | 7 runtime enums in {#} format |
| docs/user/stdlib/types/structs.md | Created | #path, #Queue |
| docs/user/stdlib/INDEX.md | Modified | Updated types section to list individual files |
| docs/user/STDLIB.md | Modified | Updated types reference |
...
- Stdlib type files restructured and using correct notation
