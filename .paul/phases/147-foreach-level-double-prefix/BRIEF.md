...
issue: 147
group: 5
group_name: "Stdlib Classification"
priority: P3-medium
status: brief-ready
---
...
| `docs/user/stdlib/expanders/ForEach/Level.md` | Documents `<level << #SomeData.SubField.~` with `.~` suffix but does not explain the grammatical basis |
...
**Source C** (`docs/user/stdlib/expanders/ForEach/Level.md`, lines ~25-26):
> ```polyglot
> [r] ~ForEach.Level
