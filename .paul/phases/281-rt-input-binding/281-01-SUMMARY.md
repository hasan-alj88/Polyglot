...
key-files:
  created:
    - docs/user/jm3lib/pipelines/Run/Function.md
    - docs/user/jm3lib/pipelines/Run/Script.md
    - docs/user/jm3lib/pipelines/Run/CLI.md
    - docs/user/jm3lib/pipelines/Run/Bind.md
...
| File | Change | Purpose |
|------|--------|---------|
| `docs/user/jm3lib/pipelines/Run/Function.md` | Created | Structured function call with `<arg`/`<kwarg` Record binding |
| `docs/user/jm3lib/pipelines/Run/Script.md` | Created | Polyglot-controlled binding — `<Bind` field names = native vars |
| `docs/user/jm3lib/pipelines/Run/CLI.md` | Created | Binary invocation with string-only Record args |
| `docs/user/jm3lib/pipelines/Run/Bind.md` | Created | Foreign-code-controlled `pull()`/`push()` binding |
...
| `docs/user/jm3lib/pipelines/Run/INDEX.md` | Modified | PGE renumbering 01029→01033 etc. |
