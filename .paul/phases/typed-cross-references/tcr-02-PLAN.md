...
And targets pointing to EBNF, syntax specs, pglib signatures, scenarios → @u:
...
<task type="auto">
  ...
  <action>
    ...
    4. Classify each using the protocol from Plan 01:
       ...
       - @u: if target is syntax spec, EBNF grammar, pglib signature, compile rule, or scenario
