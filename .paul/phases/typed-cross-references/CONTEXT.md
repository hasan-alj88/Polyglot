...
1. **Typed references** — Two types replace the current flat `@` imports:
   ...
   - `@u:` (usage) — "X appears here, defined elsewhere." Points to syntax specs, EBNF, jm3lib signatures, scenario examples
...
- Usage refs (`@u:`) point to existing spec content (EBNF, syntax, scenarios, jm3lib), not hypothetical future docs
